      ...
      <table class='table table-bordered mt-1' style="font-size: .65rem; width: 100%;">
        <thead style="max-width: 1920px; text-align: center;">
          <tr class='table table-secondary'>
            ...
            <th style="width: 3%;"><button type="button" class="btn btn-success btn-sm" style="font-size: .65rem"
        ...
        <tr id='TRow'>
          ...
          <td>
              <select name="progress[]; ?>]" class="form-select" style="font-size: .65rem; border: none;">

  ...
  <section class="shadow-lg mt-1 p-2 pt-0 my-4 rounded-3 container-fluid justify-content-center text-center ms-0">
    ...
    <form action="quot1_process.php" method='post'>
      ...
      <tbody id='TBody' style="width: 1920px;">
        <tr id='TRow'>
          <td><input type="text" class="form-control sub_no" style='border:none; text-align:center' name="sub_no[]" id="sub_no" value="<?php echo isset($row['sub_no']) ? $row['sub_no'] : '1'; ?>" readonly=""/></td>
          <td><input type='text' class="form-control group_p" style='border:none; text-align:center' placeholder='그룹' name='group_p[]' value="<?php echo isset($quote_info['group_p']) ? $quote_info['group_p'] : ''; ?>"></td>
          <td><input type='text' class="form-control sulbi" style='border:none; text-align:center' placeholder='설비명' name='sulbi[]' value="<?php echo isset($quote_info['sulbi']) ? $quote_info['sulbi'] : ''; ?>"></td>
          <td><input type='text' class="form-control model" style='border:none; text-align:center' placeholder='모델명' name='model[]' value="<?php echo isset($quote_info['model']) ? $quote_info['model'] : ''; ?>"></td>
          <td><select class="form-select apart" name='apart[]' aria-label="" style="font-size: .75rem; border:none;" value="<?php echo isset($quote_info['apart']) ? $quote_info['apart'] : ''; ?>">
          ...
          <td><input type='text' class="form-control" style='border:none; text-align:center' placeholder='품명' name='product_na[]' value="<?php echo isset($quote_info['product_na']) ? $quote_info['product_na'] : ''; ?>"></td>
          <td><input type='text' class="form-control" style='border:none; text-align:center' placeholder='사양' name='product_sp[]' value="<?php echo isset($quote_info['product_sp']) ? $quote_info['product_sp'] : ''; ?>"></td>
          <td><input type='text' class="form-control" style='border:none; text-align:center' placeholder='자재코드' name='p_code[]' value="<?php echo isset($quote_info['p_code']) ? $quote_info['p_code'] : ''; ?>"></td>
          <td><input type='text' class="form-control price" style='border:none; text-align:right; font-size:14px' name='price[]' onchange='Calc(this);' value="<?php echo isset($quote_info['price']) ? $quote_info['price'] : ''; ?>"></td>
          <td><input type='number' class="form-control qty" style='border:none; text-align:center; font-size:14px' name='qty[]' onchange='Calc(this);' value="<?php echo isset($quote_info['qty']) ? $quote_info['qty'] : ''; ?>"></td>

          <td><input type='text' class="form-control amt" style='border:none; text-align:right; font-size:14px' name='amt[]' value="<?php echo isset($quote_info['amt']) ? $quote_info['amt'] : ''; ?>"></td>
          <td><select class="form-select" name='progress[]' aria-label="" style="font-size: .75rem; text-align:center;border:none;">
            <option selected>선택</option>
          ...
          <td><input type='text' class="form-control r_quot" style='border:none; text-align:center; border-radius:0px' placeholder='관련견적' name='r_quot[]' value="<?php echo isset($quote_info['r_quot']) ? $quote_info['r_quot'] : ''; ?>"></td>
          <td><input type='text' class="form-control specif" style='border:none; text-align:center; border-radius:0px' placeholder='특기사항' name='specif[]' value="<?php echo isset($quote_info['specif']) ? $quote_info['specif'] : ''; ?>"></td>

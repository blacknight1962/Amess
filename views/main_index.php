...
<head>
    ...
    <link rel="stylesheet" href="/practice/AMESystem/public/css/main_style.css">
    <style>
    .card {
            cursor: pointer;
        }
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <img src="/practice/AMESystem/public/img/amess_logo.png" width="150" height="20">
            </div>
            <div class="d-flex justify-content-end">
                <a href="/practice/AMESystem/views/login/logout.php" style="font-size: 16px;"><i class="fa-solid fa-person-running custom-icon-size running-icon"></i>LOGOUT</a>
            </div>
        </div>
    </nav>
    ...
    <i class="fas fa-cog settings-icon"><a href="/practice/AMESystem/views/login/login_edit.php" target="_blank"></a></i>
    <!-- 로그인 모달 포함 -->

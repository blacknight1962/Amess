          ...
          <section class="shadow-lg p-1 my-1 rounded-3 container text-center">
            ...
            <div class='container-fluid' style='width: 1920px me-1 ms-1'>
              <form action="update_process.php" method='post'>
                <input type="hidden" name="action_type" value="update_basic">
                <table class='table table-bordered mt-1' style="font-size: .65rem; width: 1820px;">
                  ...
                  <tbody>
                    <tr class='custom-tr'>
                      ...
                      <td><?= createSelectOrderCustomer($conn, 'order_custo', isset($order_info['order_custo']) ? $order_info['order_custo'] : ''); ?></td>
                      <td><?= createSelectOrderCustomer($conn, 'customer', isset($order_info['customer']) ? $order_info['customer'] : ''); ?></td>
...
<div class='bg-info bg-opacity-10' style="width: 1920px; margin: 0 auto;">
  ...
  <section class="shadow-lg mt-0 p-2 pt-0 my-0 rounded-3 container-fluid justify-content-center text-center ms-0">
    <div class='container-fluid' style='width: 1890px; padding-left: 0;'>
      <form action="update_process.php"  method='post'>
        <input type='hidden' name='action_type' value='update_detail'>
...
<?php
$InTotal = 0;
$condit = isset($_SESSION['condit']) ? $_SESSION['condit'] : '기본값';
?>
<div class='bg-info bg-opacity-10 mt-1' id="partitionModal style="display: none; width: 1000px; margin: 0 auto;">
    ...
    <div class='row justify-content-end'>
      <div class='bg-warning bg-opacity-10' style="width: 1000px;">
        <div id="installmentDetails" style="border-top: 2px solid #ccc;">
          ...
          <form action="update_process.php" method='post'>
            <input type="hidden" name="action_type" value="update_installment">
            <input type="hidden" name="order_no" value="<?php echo $order_no; ?>">
            <input type="hidden" name="condit" value="<?php echo $condit; ?>">
            ...
            <button type="submit" class="btn btn-outline-success btn-sm" style="font-size: .65rem;">UPDATE-저장</button>
          </form>
        </div>
      </div>
    </div>

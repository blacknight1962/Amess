                  ...
                  <thead>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="form-control customer_name" style="font-size: .65rem" value="<?php echo $filtered["customer_name"]; ?>"></td>
...
<div class='bg-primary bg-opacity-10'>
    ...
    <div class='container-fluid' style='width: 1900px me-1 ms-1'>
      ...
      <tbody id='TBody' style="width: 1920px;">
        ...
        <tr id='TRow'>
          ...
          <td><input type="text" class="form-control group_p" style="font-size: .65rem" name="group_p[]" value="<?php echo $filtered["group_p"]; ?>"></td>
          <td><input type="text" class="form-control sulbi" style="font-size: .65rem" name="sulbi[]" value="<?php echo $filtered["sulbi"]; ?>"></td>
          <td><input type="text" class="form-control model" style="font-size: .65rem" name="model[]" value="<?php echo $filtered["model"]; ?>"></td>
          <td>
          <select name="apart[]; ?>]" class="form-select" style="font-size: .65rem">
          ...
          <td><input type="text" class="form-control product_na" style="font-size: .65rem" name="product_na[]" value="<?php echo $filtered["product_na"]; ?>"></td>
          <td><input type="text" class="form-control product_sp" style="font-size: .65rem" name="product_sp[]" value="<?php echo $filtered["product_sp"]; ?>"></td>
          <td><input type="text" class="form-control p_code" style="font-size: .65rem" name="p_code[]" value="<?php echo $filtered["p_code"]; ?>"></td>
          <td><input type="text" class="form-control price small-input" style="text-align: right;" name="price[]" value="<?php echo number_format($filtered["price"]); ?>" oninput="updatePrice(this)"></td>
          <td><input type="number" class="form-control qty small-input" style="text-align: right;" name="qty[]" value="<?php echo $filtered["qty"]; ?>" oninput="updateLineTotal(this)"></td>
          <td><input type="text" class="form-control amt small-input" style="text-align: right;" name="amt[]" value="<?php echo number_format($filtered["amt"]); ?>" readonly></td>
          <td>
          <select name="progress[]; ?>]" class="form-select" style="font-size: .65rem">
          ...
          <td><input type="text" class="form-control r_quot" style="font-size: .65rem" name="r_quot[]" value="<?php echo $filtered["r_quot"]; ?>"></td>
          <td><input type="text" class="form-control specif" style="font-size: .65rem" name="specif[]" value="<?php echo $filtered["specif"]; ?>"></td>
          <td>
            <button type="button" class="btn link-danger small-btn" style="font-size: .65rem" onclick="IcoDel(this)">
  ...
  <style>
    .small-input {
    font-size: 0.65rem; /* 또는 14px */
    text-align: right;
}
    .small-btn {
        padding: 0.20rem 0.20rem; /* 상하, 좌우 패딩 조정 */
        font-size: 0.65rem; /* 글자 크기 조정 */
    }
</style>
              <!-- Bootstrap Bundle JS -->
    <script

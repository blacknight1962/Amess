  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title fs-5" id="staticBackdropLabel">설비 추가</h4>
              ...
              <table class='table table-bordered mt-1' style="font-size: .65rem; width: 100%;">
                <thead style="max-width: 1500px; text-align: center;">
                  <tr class='table table-secondary'>
                    ...
                    <th style="width: 5%;"><button type="button" id="addbutton" class="btn btn-success" style="font-size: .65rem"
                  onclick="F_BtnAdd()">+</button></th>
                </tr>
              </thead>
              <tbody id='T_Body' style="width: 1550px;">
                <tr id='T_Row'>
                  <td><input type="text" class="sub_no" style="text-align: center;" name="sub_no[]" value="<?php echo isset($row["sub_no"]) ? $row["sub_no"] : "1"; ?>"></td>
                  <td><input type="text" class="form-control seri_no" style="font-size: .65rem" name="seri_no[]" value="<?php echo isset($row["seri_no"]) ? $row["seri_no"] : ""; ?>"></td>
                  <td><input type="date" class="form-control date_supply" style="font-size: .65rem" name="date_supply[]" value="<?php echo isset($row["date_supply"]) ? $row["date_supply"] : ""; ?>"></td>
                  <td><input type="text" class="form-control place_fac" style="font-size: .65rem" name="place_fac[]" value="<?php echo isset($row["place_fac"]) ? $row["place_fac"] : ""; ?>"></td>
                  <td><input type="text" class="form-control line_no" style="font-size: .65rem" name="line_no[]" value="<?php echo isset($row["line_no"]) ? $row["line_no"] : ""; ?>"></td>
                  <td><input type="text" class="form-control custo_nick" style="font-size: .65rem" name="custo_nick[]" value="<?php echo isset($row["custo_nick"]) ? $row["custo_nick"] : ""; ?>"></td>
                  <td><input type="text" class="form-control sw_ver" style="font-size: .65rem" name="sw_ver[]" value="<?php echo isset($row["sw_ver"]) ? $row["sw_ver"] : ""; ?>"></td>
                  <td><select class="form-select" name="manage_stat[]" aria-label="" style="font-size: .65rem" value="<?php echo isset($row['manage_stat']) ? $row['manage_stat'] : ''; ?>">
                  ...
                  <td><input type="text" class="form-control specif" style="font-size: .65rem" name="specif[]" value="<?php echo isset($row["specif"]) ? $row["specif"] : ""; ?>"></td>
                  <td>
...
<div class='bg-danger bg-opacity-10' style='text-align: center;'>
  ...
  <section class="shadow-lg mt-2 p-2 pt-0 my-4 rounded-3 container-custom text-center justify-content-center">
    ...
    <!-- 장비관리- 설비 추가 -->
    <div class='card-body'>
      <!-- <div id="equipment_basic_info"></div> -->
  ...
  <div class='row justify-content-center' style="max-width: 1550px; margin: 0 auto;">
    <section class="shadow-lg mt-1 p-1 pt-0 my-4 rounded-3 container-fluid justify-content-center text-center ms-0">
          ...
          <table class='table table-bordered mt-1' style="font-size: .65rem; width: 100%;">
            <thead style="max-width: 1500px; text-align: center;">
              <tr class='table table-secondary'>
                ...
                <th style="width: 17%;">특기사항</th>
                <th style="width: 5%;"><button type="button" id="addBtton" class="btn btn-success" style="font-size: .65rem" onclick="FT_BtnAdd()">+</button></th>
              </tr>
            </thead>
            <tbody id='FT_Body' style="width: 1550px;">
              <?php
            ...
            ?>
              <tr id='FT_Row' data-e-no="<?php echo $filtered['e_no']; ?>"> <!-- e_no 값을 data 속성으로 추가 -->
                <td><input type="text" class="sub_no" style="text-align: center;" name="sub_no[]" value="<?php echo $filtered["sub_no"]; ?>"></td>
                <td><input type="text" class="form-control seri_no" style="font-size: .65rem" name="seri_no[]" value="<?php echo $filtered["seri_no"]; ?>"></td>
                <td><input type="text" class="form-control date_supply" style="font-size: .65rem" name="date_supply[]" value="<?php echo $filtered["date_supply"]; ?>"></td>
                <td><input type="text" class="form-control place_fac" style="font-size: .65rem" name="place_fac[]" value="<?php echo $filtered["place_fac"]; ?>"></td>
                <td><input type="text" class="form-control line_no" style="font-size: .65rem" name="line_no[]" value="<?php echo $filtered["line_no"]; ?>"></td>
                <td><input type="text" class="form-control custo_nick" style="font-size: .65rem" name="custo_nick[]" value="<?php echo $filtered["custo_nick"]; ?>"></td>
                <td><input type="text" class="form-control sw_ver" style="font-size: .65rem" name="sw_ver[]" value="<?php echo $filtered["sw_ver"]; ?>"></td>
                <td><?= createSelectStatus($conn, 'manage_stat[]', $filtered['manage_stat']); ?></td>
                <td><input type="text" class="form-control specif" style="font-size: .65rem" name="specif[]" value="<?php echo $filtered["specif"]; ?>"></td>
                <td>
                  <button type="button" class="btn link-danger small-btn btn-delete-db BtnDelF" style="font-size: .65rem">
                    <i class="fa-solid fa-trash fs-6"></i>
                  </button>
                    <a href="task_manage.php?e_no=<?= $filtered['e_no'] ?>&sub_no=<?= $filtered['sub_no'] ?>&seri_no=<?= $filtered['seri_no'] ?>"" class="link-secondary" title="상세정보">
      ...
      <?php    } //while 문 종료 
              ...
              //if문 else 종료 
            } else { //e_no 가 비어있는 경우  if문 else 종료 
